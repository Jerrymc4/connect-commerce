...
<div class="bg-white rounded-lg shadow-sm p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2">
            ...
            <a href="https://{{ $store->domain }}" target="_blank" class="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-200 transition flex items-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-6">
            <h2 class="text-lg font-medium text-gray-900 mb-4 flex items-center">
                <i class="fas fa-store text-blue-500 mr-2"></i> Store Information
            </h2>
            ...
            <div class="mb-6 flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ 
                        isset($store) && $store->status == 'active' ? 'bg-green-100 text-green-800' : 
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-6">
            <h2 class="text-lg font-medium text-gray-900 mb-4 flex items-center">
                <i class="fas fa-globe text-blue-500 mr-2"></i> Domain Information
            </h2>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <span class="ml-2 px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ 
                        isset($store) && ($store->dns_status ?? '') == 'verified' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' 
                    }}">
                ...
                <div>
                    ...
                    <span class="ml-2 px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ 
                        isset($store) && ($store->ssl_status ?? '') == 'active' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' 
                    }}">
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-6">
            <h2 class="text-lg font-medium text-gray-900 mb-4 flex items-center">
                <i class="fas fa-user text-blue-500 mr-2"></i> Owner Information
            </h2>
            
            <div class="mb-4 flex items-center">
                <div class="h-12 w-12 flex-shrink-0 rounded-full bg-gray-200 flex items-center justify-center">
