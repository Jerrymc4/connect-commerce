...
<div class="bg-white rounded-lg shadow-lg p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div class="bg-blue-100 rounded-lg p-6 border border-blue-200 shadow-md">
                    ...
                    @if(isset($recentOrders) && count($recentOrders) > 0)
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $order->status == 'completed' ? 'bg-blue-100 text-blue-800' : ($order->status == 'processing' ? 'bg-gray-100 text-gray-800' : 'bg-gray-100 text-gray-800') }}">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            @if(isset($topProducts) && count($topProducts) > 0)
                <ul class="divide-y divide-gray-200">
                    ...
                    <li class="py-3 flex justify-between items-center">
                        <div class="flex items-center">
                            <div class="bg-blue-100 rounded-md w-10 h-10 flex items-center justify-center mr-3">
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-md">
            ...
            <div class="h-80 bg-gray-100 rounded-lg p-4 flex items-end justify-between space-x-2">
                <!-- Placeholder for actual chart -->
                <div class="bg-blue-600 w-1/12 rounded-t-sm h-1/5"></div>
                <div class="bg-blue-600 w-1/12 rounded-t-sm h-2/6"></div>
                <div class="bg-blue-600 w-1/12 rounded-t-sm h-1/4"></div>
                <div class="bg-blue-600 w-1/12 rounded-t-sm h-3/6"></div>
                <div class="bg-blue-600 w-1/12 rounded-t-sm h-1/2"></div>
                <div class="bg-blue-600 w-1/12 rounded-t-sm h-4/6"></div>
                <div class="bg-blue-600 w-1/12 rounded-t-sm h-3/4"></div>
                <div class="bg-blue-600 w-1/12 rounded-t-sm h-5/6"></div>
                <div class="bg-blue-600 w-1/12 rounded-t-sm h-2/3"></div>
                <div class="bg-blue-600 w-1/12 rounded-t-sm h-4/5"></div>
                <div class="bg-blue-600 w-1/12 rounded-t-sm h-5/6"></div>
                <div class="bg-blue-600 w-1/12 rounded-t-sm h-full"></div>
            </div>
