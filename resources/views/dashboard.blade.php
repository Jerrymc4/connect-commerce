        ...
        <div class="bg-white overflow-hidden shadow-lg rounded-lg">
            ...
            <div class="p-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <form method="POST" action="{{ request()->getHost() !== config('tenancy.central_domains.0') ? route('tenant.logout') : route('logout') }}">
                            @csrf
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <!-- Sales Card -->
                    <div class="bg-blue-100 rounded-lg p-6 shadow-md border border-blue-200">
                    ...
                    <!-- Orders Card -->
                    <div class="bg-gray-100 rounded-lg p-6 shadow-md border border-gray-200">
                        <div class="flex items-center">
